...
createChannel(){
    ...
    peer channel create -o 35.223.189.30:7050 -c $CHANNEL_NAME \
...
updateAnchorPeers(){
    setGlobalsForPeer0thayson
    # Replace localhost with your orderer's vm IP address
    peer channel update -o 35.223.189.30:7050 --ordererTLSHostnameOverride orderer.thesis.com -c $CHANNEL_NAME -f ./../../artifacts/channel/${CORE_PEER_LOCALMSPID}anchors.tx --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA
